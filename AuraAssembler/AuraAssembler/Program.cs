...
namespace AuraAssembler
{
    class Program
    {
        ...
        static void Init()
        {
            ...
            instruction.Add("SYS", new Instruction(16, "SYS", 1)); // <reg>

            instruction.Add("AND", new Instruction(32, "ADD", 1, 1)); // <reg>, <reg>
            instruction.Add("OR", new Instruction(34, "OR", 1, 1)); // <reg>, <reg>
            instruction.Add("XOR", new Instruction(36, "XOR", 1, 1)); // <reg>, <reg>
            ...
            instruction.Add("MOV", new Instruction(48, "MOV", 1, 1)); // <reg>, <reg>
